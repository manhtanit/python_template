...
[![codecov](https://codecov.io/gh/manhtanit/python_template/branch/main/graph/badge.svg?token=python_template_token_here)](https://codecov.io/gh/manhtanit/python_template)
[![CI](https://github.com/manhtanit/python_template/actions/workflows/main.yml/badge.svg)](https://github.com/manhtanit/python_template/actions/workflows/main.yml)

Awesome python_template created by manhtanit

## Install

from source
```bash
git clone https://github.com/manhtanit/python_template python_template
cd python_template
make install
```
...
```bash
$ python_template run --port 8080
```

or

```bash
python -m python_template run --port 8080
```

or

```bash
$ uvicorn python_template:app
```
...
Usage: python_template [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ python_template create-user --help
Usage: python_template create-user [OPTIONS] USERNAME PASSWORD
...
```bash
python_template create-user admin admin --superuser
```
...
Run with `python_template run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `python_template create-user`.
...
python_template/app.py                  16      1    94%
python_template/cli.py                  21      0   100%
python_template/config.py                5      0   100%
python_template/db.py                   10      0   100%
python_template/models/__init__.py       0      0   100%
python_template/models/content.py       47      1    98%
python_template/routes/__init__.py      11      0   100%
python_template/routes/content.py       52     25    52%
python_template/routes/security.py      15      1    93%
python_template/routes/user.py          52     26    50%
python_template/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in python_template/default.toml.
