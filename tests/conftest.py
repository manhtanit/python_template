...
# WARNING: Ensure imports from `python_template` comes after this line
from python_template import app, settings, db  # noqa
from python_template.cli import create_user, cli  # noqa
